...
FLAGS.train_data_paths = '/path to train data'
FLAGS.valid_data_paths = '/path to validation data'
FLAGS.save_dir = '/path to save checkpoints'
FLAGS.gen_frm_dir = '/path to save the results'
FLAGS.pretrained_model = ''

FLAGS.is_training = True 
FLAGS.dataset_name =  'action'
FLAGS.input_length = 10
FLAGS.seq_length = 30
FLAGS.total_length =  30
FLAGS.img_width = 120 #160*120 frames
FLAGS.img_channel = 1
FLAGS.patch_size = 4
...
FLAGS.lr = 0.001
FLAGS.batch_size = 2# 20
FLAGS.max_iterations = 80000
FLAGS.display_interval = 1
FLAGS.test_interval = 1000
FLAGS.snapshot_interval = 10 #1000 #number of iters saving models.
FLAGS.num_save_samples = 20 #number of sequences to be saved.
FLAGS.n_gpu = 16 #2
